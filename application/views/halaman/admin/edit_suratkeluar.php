  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            <?php foreach($suratkeluar as $sr)?>
            <!-- Recent Sales -->
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                  <h4 class="card-title">Identitas Surat Keluar</h4>
                  <form action="<?=base_url('admin/edit_suratkeluar')?>" method="post" enctype="multipart/form-data">
                  <div class="row mb-3">
                    ...
                    <div>
                      ...
                      <a href="<?=base_url('admin/suratkeluar')?>" class="btn btn-danger btn-sm">Batal</a>
                    </div>
