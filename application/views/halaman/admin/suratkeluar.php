            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                    ...
                    <a href="<?=base_url('admin/tambah_suratkeluar')?>" class="btn btn-success btn-sm mb-3">Tambah</a>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a title="Edit" href="<?=base_url('admin/edit_suratkeluar/').$d->id_arsip?>" class="btn btn-success btn-sm mb-1"><i class="bi bi-pencil"></i></a>

                          <a title="Hapus" href="<?=base_url('admin/hapus_suratkeluar/').$d->id_arsip?>" class="btn btn-danger btn-sm mb-1" onclick="return confirm('Yakin ingin menghapus data ini?')"><i class="bi bi-trash"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                    </tbody>
