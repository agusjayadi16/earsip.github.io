            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                  ...
                  <form action="<?=base_url('user/edit_suratkeluar')?>" method="post" enctype="multipart/form-data">
                  <div class="row mb-3">
                    ...
                    <div>
                      ...
                      <a href="<?=base_url('user/suratkeluar')?>" class="btn btn-danger btn-sm">Batal</a>
                    </div>
